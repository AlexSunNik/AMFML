...
if __name__ == "__main__":
    ...
    parser.add_argument('--afrm', action='store_true')
    ...
    if afrm:
        network_name = "nyu_seg_sn_afrm"
        save_path = f"/data/alexsun/ckp/nyuv2/final_nyu_seg_sn_afrm.pth"
    else:
        network_name = "nyu_seg_sn"
        save_path = f"/data/alexsun/ckp/nyuv2/final_nyu_seg_sn.pth"
    ...
    res = evaluator.get_final_metrics(net, test_loader, afrm = afrm)
